...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-SnapWUT/Bolts.framework"
  install_framework "Pods-SnapWUT/FBSDKCoreKit.framework"
  install_framework "Pods-SnapWUT/FBSDKLoginKit.framework"
